...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Perde — Sinema Haberleri, İncelemeler, Listeler" },
      ...
      { name: "twitter:title", content: "Perde — Sinema Haberleri, İncelemeler, Listeler" },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Anton&family=Inter:wght@400;500;600;700;800&family=Playfair+Display:ital,wght@0,700;0,900;1,700&display=swap" },
    ],
  }),
