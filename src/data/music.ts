...
export const MUSIC: MusicItem[] = [
  {
    slug: "desiigner-tutuklandi-aile-ici-siddet",
    title: "\"Panda\"nın Rapçisi Desiigner Aile İçi Şiddet Suçlamasıyla Tutuklandı",
    excerpt: "Sidney Selby III olarak bilinen rapçi Desiigner, Güney Carolina'da ikinci derece aile içi şiddet suçlamasıyla tutuklandı. 28 yaşındaki sanatçı, Horry County kayıtlarına göre kefaletsiz olarak nezarette bekliyor.",
    body: "Rapçi Desiigner (gerçek adıyla Sidney Selby III), Çarşamba günü (15 Temmuz) Güney Carolina'da ikinci derece aile içi şiddet suçlamasıyla tutuklandı. Horry County Şerif Ofisi kayıtlarına göre \"Panda\" şarkısıyla tanınan sanatçı, öğleden sonra 2:21'de gözaltına alındı ve haberin yayımlandığı sırada hâlâ kefaletsiz olarak nezarette bekliyordu.\n\nTutuklamanın ayrıntıları henüz kamuoyuyla paylaşılmadı. Desiigner'ın son yıllarda ardı ardına gelen adli sorunları olmuştu: 2023'te bir uçakta müstehcen davranıştan suçlanmış, geçen yıl da Güney Carolina'da bir başka gözaltı olayı yaşamıştı. Bu son gelişme, kariyerinin en sıkıntılı dönemlerinden birini derinleştiriyor.\n\nSanatçı 2016'da yayımlanan ve Billboard Hot 100'ün zirvesine çıkan \"Panda\" ile şöhrete kavuşmuştu. Şarkı, Kanye West'in aynı yıl çıkardığı \"The Life of Pablo\" albümündeki \"Pt. 2\" parçasında da örneklenmiş, Desiigner'a G.O.O.D. Music etiketiyle bir sözleşme getirmişti. Ancak sonraki yıllarda çıkış döneminin başarısını sürdüremeyen sanatçı, adli sicilindeki artan olaylarla daha çok gündeme geldi.\n\nBillboard, sanatçının temsilcilerinden yorum talebinde bulunduğunu ancak henüz yanıt alamadığını bildirdi.",
    image: "https://www.billboard.com/wp-content/uploads/2026/07/1136254158-e1784318593674.jpg?w=1600",
    source: "Billboard",
  },
  {
    slug: "rolling-stones-billboard-kapak-jagger-richards",
    title: "82 Yaşında Kükrüyorlar: Mick Jagger ve Keith Richards'la Billboard Kapak Söyleşisi",
    excerpt: "Rolling Stones, yeni albümleri 'Foreign Tongues' ile Billboard'un kapağına döndü. 82 yaşındaki Jagger ve Richards; turne, yapay zekâ ve ortaklıklarını hâlâ neyin ayakta tuttuğu üzerine konuştu.",
    body: "Billboard'un yeni kapağında Rolling Stones var: 82 yaşındaki Mick Jagger ve Keith Richards, yeni albümleri 'Foreign Tongues'un çıkışıyla birlikte rock tarihinin en uzun soluklu ortaklığını yeniden masaya yatırdı. Batı Londra'daki bir havuz kenarında Jagger, gazeteci Joe Lynch'e alaycı bir açılış yapıyor: \"Terbiyeli ve İngiliz mi olsam, kaba ve New York'lu mu?\" On sekiz yılını New York'ta geçirmiş, 2003'te şövalyelik almış olan Jagger, bir Jumpin' Jack anında iki modu da giyip çıkarabildiğini kanıtlıyor.\n\nRöportaj sadece anıya değil, aynı zamanda grubun hâlâ neden ürettiğine odaklanıyor. Jagger, fizikten havacılığa uzanan meraklarının şarkı sözlerine sızmaya devam ettiğini; Richards ise ikilinin stüdyodaki dinamiğinin \"birinin diğerinin yazdığını bozmadan zenginleştirmesi\" üzerine kurulu olduğunu anlatıyor. Yapay zekâ ise gündemin en tartışmalı konusu: her iki müzisyen de teknolojinin şarkı yazımını yerinden edecek bir düşman olarak değil, kısıtlı ama uyanık kullanıldığında ilginç bir araç olarak görüyor.\n\n'Foreign Tongues' albümüne Amy Winehouse başta olmak üzere pek çok özel konuğun katkı verdiği belirtiliyor. Turne planları, sahne prodüksiyonu ve grubun \"müzikal Rushmore Dağı\" olarak kimleri gördüğü de söyleşinin dallanan hatları arasında. Jagger'ın belirttiği gibi, altmış yılı aşan bir yol arkadaşlığı bugün hâlâ \"başlangıçtaki merakla\" çalıyor: \"Sahneye çıkmadan önce hâlâ heyecanlanıyoruz. Bu tuhaf ama gerçek.\"",
    image: "https://www.billboard.com/wp-content/uploads/2026/07/cover-rolling-stones-billboard-2026-bb7-joe-pugliese-kevin-mazur-2-1800.jpg?w=1600",
    source: "Billboard",
  },
  {
    slug: "rolling-stones-amy-winehouse-tamamlanmamis-muzik",
    title: "Rolling Stones, Amy Winehouse'un Tamamlanmamış Bir Şarkısını Yeni Albümlerine Aldı",
    excerpt: "Rolling Stones, 'Foreign Tongues' albümüne özel konuk olarak Amy Winehouse'un bugüne kadar duyulmamış bir vokal kaydını dahil etti. Grup yapay zekâ tartışmalarına da açıklık getirdi.",
    body: "Rolling Stones, yeni albümleri 'Foreign Tongues'un ayrıntılarını Billboard'a verdikleri kapak söyleşisinde paylaştı ve albümdeki en dikkat çekici konuğun Amy Winehouse olduğunu açıkladı. Grup, ünlü şarkıcının tamamlanmamış bir vokal kaydını albümdeki bir parçaya yerleştirdiklerini, bunun yapay zekâ ile üretilmiş bir simülasyon olmadığını, kayıtlarda uzun süredir bekleyen gerçek bir performans olduğunu vurguladı.\n\nMick Jagger ve Keith Richards, yapay zekânın müzikte yarattığı tartışmalara net bir tavır aldıklarını ifade etti. Jagger'a göre Winehouse'un dahil edilmesi kesinlikle bir AI numarası değil: \"Amy'nin sesi orada, gerçek. Biz sadece onun etrafında bir şarkı inşa ettik.\" Richards ise stüdyoda hâlâ analog bir ruh aradıklarını, ancak dijital dünyayı reddetmediklerini söyledi.\n\nAlbüm; 5 Mayıs'ta Brooklyn'deki The Weylin mekânında düzenlenen özel bir davetle tanıtılmıştı. O gecenin fotoğrafları Jagger, Richards ve Ronnie Wood'u basına ve konuklara albümü ilk kez dinletirken gösteriyor. 'Foreign Tongues', grubun 2023'teki 'Hackney Diamonds' albümünün ardından iki yıllık kısa bir arayla gelen yeni stüdyo çalışması olarak dikkat çekiyor.\n\nWinehouse'un mirasını yönetenler ile Stones tarafı arasında yapılan anlaşmanın ayrıntıları paylaşılmadı, ancak grup şarkının Winehouse'un ailesinin onayıyla yayımlandığını belirtti.",
    image: "https://www.billboard.com/wp-content/uploads/2026/07/2274703848-e1784152721420.jpg?w=1600",
    source: "Billboard",
  },
  {
    slug: "ozzy-osbourne-ozzy-day-birmingham",
    title: "Birmingham, Ozzy Osbourne'u Vefatının Birinci Yılında \"Ozzy Günü\" ile Anıyor",
    excerpt: "Metal ikonu Ozzy Osbourne, ölümünün birinci yılında memleketi Birmingham'da düzenlenecek bir günlük konserler, film gösterimleri ve etkinliklerle anılacak. Şehir bu güne resmî olarak \"Ozzy Günü\" adını verdi.",
    body: "Metal müziğin efsanevi ismi Ozzy Osbourne, geçen yıl aramızdan ayrılışının birinci yıl dönümünde memleketi Birmingham'da bir dizi etkinlikle anılacak. Şehir yönetimi, bu günü resmî olarak \"Ozzy Günü\" ilan etti; program konserler, film gösterimleri ve şehrin çeşitli noktalarında düzenlenecek anma törenlerinden oluşacak.\n\nBirmingham Belediyesi'nden yapılan açıklamada, günün yalnızca bir yas değil, aynı zamanda kutlama olarak tasarlandığı belirtildi. Osbourne'un Black Sabbath ile başlayıp solo kariyerinde dünya çapına yayılan mirası, gün boyunca farklı etkinliklerle vurgulanacak. Şehrin merkezindeki bar ve mekânlarda tribute konserleri düzenlenecek, sinemalarda Osbourne'un hayatını anlatan belgeseller gösterilecek.\n\nOzzy Osbourne, geçen yıl memleketi Birmingham'da yapılan kamuya açık cenaze törenine binlerce kişinin katıldığı görkemli bir uğurlamayla toprağa verilmişti. Sabbath'ın diğer üyeleri Tony Iommi, Geezer Butler ve Bill Ward da o dönemde bir dizi paylaşımla \"sevgili dostumuza veda\" mesajı vermişti.\n\n\"Ozzy Günü\" etkinliklerinin en dikkat çekici anlarından biri, sanatçının doğduğu Aston bölgesindeki köprünün bulunduğu meydanda yapılacak açık hava töreninin canlı yayınlanacak olması. Birmingham, kentin en tanınmış evladının anısını kalıcı bir şekilde onurlandırmayı hedeflediklerini vurguladı.",
    image: "https://www.billboard.com/wp-content/uploads/2025/08/ozzy-osbourne-portrait-1984-billboard-1800.jpg?w=1600",
    source: "Billboard",
  },
  {
    slug: "ingiliz-hitleri-abd-de-tutmayan-sarkilar",
    title: "\"Mull of Kintyre\"dan \"Rein Me In\"e: İngiltere'yi Sallayıp ABD'de Tutmayan Şarkılar",
    excerpt: "Billboard, Hot 100'ün başladığı 1958'den bu yana İngiltere listelerinin zirvesinde uzun süre kalıp ABD Hot 100'ünde top 10'a giremeyen şarkıları sıraladı. Listede Wings'in \"Mull of Kintyre\"ından Sam Fender & Olivia Dean'in \"Rein Me In\"ine uzanan bir tablo var.",
    body: "Amerikan ve İngiliz dinleyicilerin hit anlayışları çoğu zaman örtüşse de her zaman değil. Billboard, 1958'de başlayan Hot 100 tarihinde İngiliz Official Singles Chart'ta sekiz hafta ve üzeri bir numarada kalıp ABD listelerinde top 10'a hiç girememiş dokuz şarkıyı derledi.\n\nListenin en çarpıcı ismi Wings'in 1977'de Paul McCartney tarafından yazdığı \"Mull of Kintyre / Girls' School\" çift A-yüzlü teki. Şarkı İngiltere'de dokuz hafta zirvede kaldı ve Beatles sonrası McCartney'nin ülkesindeki ilk bir numarası oldu; ABD tarafında ise \"Girls' School\" yüzü Hot 100'de yalnızca 33 numaraya kadar çıkabildi. McCartney ve Denny Laine, şarkıyı McCartney'nin 1966'dan beri sahip olduğu İskoçya'nın güneybatısındaki High Park Farm çevresindeki bölgeye adamıştı; kayıtta Campbeltown Pipe Band'ın gaydaları belirleyici sese dönüşmüştü.\n\nListenin diğer ucunda 2026'nın Sam Fender ve Olivia Dean'i var. İkilinin \"Rein Me In\" şarkısı Temmuz güncellemesiyle birlikte İngiltere'de bir numarada 17. haftasını doldurdu; ancak Hot 100'de 64 numaraya kadar tırmandıktan sonra 90'a geriledi. Billboard bunu şu satırla özetliyor: \"Hot 100 tarihinde 17 hafta İngiliz zirvesinde kalıp Hot 100'ün ilk 40'ına bile giremeyen ilk single Rein Me In oldu.\"\n\nListede The Shadows'un 1962 tarihli enstrümantal klasiği \"Wonderful Land\" ve pek çok başka İngiliz kültürel fenomeni de yer alıyor. Billboard, iki ülkenin pop zevkinin son 68 yılda hiç bu kadar açık farkla ayrışmadığını belirtiyor.",
    image: "https://upload.wikimedia.org/wikipedia/en/f/fd/Mull_of_Kintyre_%28Wings_song_cover_art%29.jpg",
    source: "Billboard",
  },
