...
export const NEWS: NewsItem[] = [
  {
    ...
    title: "'Practical Magic 2' Fragmanı Yayınlandı: Owens Cadıları Lanetle Yüzleşiyor",
  ...
  },
  {
    ...
    title: "Blair Cadısı Kabusu Geri Dönüyor: Korku Klasiği TikTok Çağına Uyum Sağlayabilecek mi?",
  ...
  },
  {
    ...
    title: "Sürpriz İkili: Kylie Minogue ve Quentin Tarantino Aynı Filmde!",
  ...
  {
    slug: "not-alone",
    title: "Timothée Chalamet ve Selena Gomez Uzay Macerasında Buluşuyor: İşte 'Not Alone'",
  ...
  },
  {
    ...
    title: "Amazon, OpenAI ile Anlaşınca Kendi OpenAI Filmini Rafa Kaldırdı",
